...
Posterno component that provides geocoding and reverse geocoding for the supported maps providers.

## Installation

This is a development repository for the geocoder component and requires no installation for production sites because it's integrated within Posterno's core plugin.
